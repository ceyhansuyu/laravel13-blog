...
'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title],ul,ol,li,p[style],br,span,img[width|height|alt|title|src],blockquote,pre,strong[style],iframe[src|width|height|frameborder]',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align',
            'AutoFormat.AutoParagraph' => false,
            'AutoFormat.RemoveEmpty' => false,
            
            // YouTube ve Iframe ayarları
            'HTML.SafeIframe' => true,
            'URI.SafeIframeRegexp' => '%^https://(www\.)?youtube\.com/embed/%',

            // Hafıza (Cache) yönetimi için bunlar kalabilir, HTML Purifier için güvenlidir
            'HTML.DefinitionID' => 'quill-youtube-custom-purifier',
