<x-app-layout :title="__('Edit Page')">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Page: ') }} <span class="text-indigo-600 dark:text-indigo-400">{{ $page->title }}</span>
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.pages.update', $page) }}" method="POST" id="page-form">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $page->title) }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-2.5 px-4">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug', $page->slug) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-2.5 px-4">
                    </div>
                    ...
                    <div class="mb-6 flex items-center">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $page->is_active) ? 'checked' : '' }} class="rounded border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-indigo-600 focus:ring-indigo-500 w-5 h-5 cursor-pointer">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // 5. Transfer Quill Content to Hidden Input on Form Submit
            ...
            // 6. Alpine.js Event Listener (Flexible Selector)
